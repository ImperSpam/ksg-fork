...
$aR301SkipCheck = array(
	...
	// '/link1'=>'/link1',
	'/c/metalloprokat/armatura/gladkaya/12mm/'=>'/c/metalloprokat/armatura/gladkaya/12mm-gladkaya/',
	'/c/metalloprokat/armatura/a3/12mm/'=>'/c/metalloprokat/armatura/a3/12mm-a3/',
'/c/ocinkovka/truby-elektrosvarnye/'=>'/c/chernyj-metall/truby/vgp-elektrosvarnye-truby/truby-elektrosvarnye-ocinkovannye/',
);
...
function durIFRewrite()
{
	...
	$sURLParts = explode('?', $sKey, 2);

	if (isset($sURLParts[1])) {
		$sQueryString = $sURLParts[1];
		$sKey = $sURLParts[0];
	}
